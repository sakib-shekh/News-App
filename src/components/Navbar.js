...
export default class Navbar extends Component {
  ...
  render() {
    return (
        <nav className="navbar fixed-top navbar-expand-lg" style={{backgroundColor:"pink"}}>
        <div className="container-fluid">
          ...
          <li className="nav-item">
            ...
            <form className="d-flex" role="search">
              ...
              <button className="btn btn-outline-success" type="submit" onClick={this.SearchThe}>Search</button>
            </form>
          </div>
        </div>
